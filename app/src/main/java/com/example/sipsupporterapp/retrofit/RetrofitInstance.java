...
public class RetrofitInstance {
    ...
    public static Retrofit paymentInfoRI(Type type, Object typeAdapter, Context context) {
        OkHttpClient client = new OkHttpClient.Builder()
                .addInterceptor(new ConnectivityInterceptor(context))
                .connectTimeout(1, TimeUnit.MINUTES)
                .readTimeout(30, TimeUnit.SECONDS)
        ...
        return new Retrofit.Builder()
                .baseUrl("http://" + BASE_URL + "/api/v1/paymentSubjects/Info/")
                .addConverterFactory(createConverter(type, typeAdapter))
                .client(client)
                .build();
    }
    ...
    public static Retrofit getAttachmentListByPaymentIDRI(Type type, Object typeAdapter, Context context) {
        OkHttpClient client = new OkHttpClient.Builder()
                .addInterceptor(new ConnectivityInterceptor(context))
                .connectTimeout(1, TimeUnit.MINUTES)
                .readTimeout(30, TimeUnit.SECONDS)
        ...
        return new Retrofit.Builder()
                .baseUrl("http://" + BASE_URL + "/api/v1/attach/List_ByPayment/")
                .addConverterFactory(createConverter(type, typeAdapter))
                .client(client)
                .build();
    }
