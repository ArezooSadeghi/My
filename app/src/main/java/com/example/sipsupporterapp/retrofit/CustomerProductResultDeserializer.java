...
public class CustomerProductResultDeserializer implements JsonDeserializer<CustomerProductResult> {
    @Override
    public CustomerProductResult deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        Gson gson = new Gson();
        return gson.fromJson(bodyObject.toString(), CustomerProductResult.class);
    }
}
