...
public class SuccessAddEditNewCustomerPaymentDialogFragment extends DialogFragment {
    private FragmentSuccessDialogBinding binding;
    private NewCustomerPaymentsViewModel viewModel;

    private static final String ARGS_MESSAGE = "message";

    public static final String TAG = SuccessAddEditNewCustomerPaymentDialogFragment.class.getSimpleName();

    public static SuccessAddEditNewCustomerPaymentDialogFragment newInstance(String message) {
        SuccessAddEditNewCustomerPaymentDialogFragment fragment = new SuccessAddEditNewCustomerPaymentDialogFragment();
