...
public class QuestionDeletePhotoDialogFragment extends DialogFragment {
    private FragmentQuestionDialogBinding binding;
    private AttachmentViewModel viewModel;

    private static final String ARGS_MESSAGE = "message";

    public static final String TAG = QuestionDeletePhotoDialogFragment.class.getSimpleName();

    public static QuestionDeletePhotoDialogFragment newInstance(String message) {
        QuestionDeletePhotoDialogFragment fragment = new QuestionDeletePhotoDialogFragment();
