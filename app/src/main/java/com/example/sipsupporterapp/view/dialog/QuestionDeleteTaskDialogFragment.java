...
public class QuestionDeleteTaskDialogFragment extends DialogFragment {
    ...
    public static QuestionDeleteTaskDialogFragment newInstance(String message) {
        QuestionDeleteTaskDialogFragment fragment = new QuestionDeleteTaskDialogFragment();
