...
public class QuestionDeletePaymentDialogFragment extends DialogFragment {
    private FragmentQuestionDialogBinding binding;
    private PaymentViewModel viewModel;

    private static final String ARGS_MESSAGE = "message";

    public static final String TAG = QuestionDeletePaymentDialogFragment.class.getSimpleName();

    public static QuestionDeletePaymentDialogFragment newInstance(String message) {
        QuestionDeletePaymentDialogFragment fragment = new QuestionDeletePaymentDialogFragment();
