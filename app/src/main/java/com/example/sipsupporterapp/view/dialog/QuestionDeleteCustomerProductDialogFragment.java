...
public class QuestionDeleteCustomerProductDialogFragment extends DialogFragment {
    private FragmentQuestionDialogBinding binding;
    private CustomerProductViewModel viewModel;

    private static final String ARGS_MESSAGE = "message";

    public static final String TAG = QuestionDeleteCustomerProductDialogFragment.class.getSimpleName();

    public static QuestionDeleteCustomerProductDialogFragment newInstance(String message) {
        QuestionDeleteCustomerProductDialogFragment fragment = new QuestionDeleteCustomerProductDialogFragment();
